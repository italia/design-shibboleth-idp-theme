...
Template css/html per Shibboleth Identity Provider (IdP ver. > 4.1) costruito al di sopra di [Bootstrap Italia v1.4.3](https://italia.github.io/bootstrap-italia/).
